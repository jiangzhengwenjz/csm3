First, you must put a Summon Night Swordcraft Story 3: Stone of Beginnings (サモンナイト クラフトソード物語 はじまりの石) ROM (with SHA1: `3f5253fcf57e07ce52472bd29a61d16b98a12376`) in the root directory of the repository and name it `baserom.gba`. 
