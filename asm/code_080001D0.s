...
sub_08001624: @ 0x08001624
	...
	bx r0
	.align 2, 0
_0800169C: .4byte 0x00034BC0

	thumb_func_start sub_080016A0
sub_080016A0: @ 0x080016A0
	ldr r0, _080016C0 @ =gUnk_0300294C
	movs r1, #0
	strh r1, [r0]
	ldr r0, _080016C4 @ =gUnk_03002944
	strh r1, [r0]
	ldr r0, _080016C8 @ =gUnk_03002950
	movs r1, #0
	str r1, [r0]
	ldr r0, _080016CC @ =gUnk_03002948
	strh r1, [r0]
	ldr r1, _080016D0 @ =gUnk_0300295C
	movs r0, #0x80
	lsls r0, r0, #0x12
	str r0, [r1]
	bx lr
	.align 2, 0
_080016C0: .4byte gUnk_0300294C
_080016C4: .4byte gUnk_03002944
_080016C8: .4byte gUnk_03002950
_080016CC: .4byte gUnk_03002948
_080016D0: .4byte gUnk_0300295C

	thumb_func_start sub_080016D4
sub_080016D4: @ 0x080016D4
	ldr r1, _080016DC @ =gUnk_0300295C
	str r0, [r1]
	bx lr
	.align 2, 0
_080016DC: .4byte gUnk_0300295C

	thumb_func_start sub_080016E0
sub_080016E0: @ 0x080016E0
	push {lr}
	ldr r1, _080016FC @ =gUnk_03002954
	ldr r0, _08001700 @ =gUnk_03003364
	ldr r0, [r0]
	str r0, [r1]
	ldr r0, _08001704 @ =0x04000006
	ldrh r0, [r0]
	movs r1, #0xff
	ands r1, r0
	cmp r1, #0x9e
	...
	b _08001710
	.align 2, 0
_080016FC: .4byte gUnk_03002954
_08001700: .4byte gUnk_03003364
_08001704: .4byte 0x04000006
_08001708:
	adds r0, r1, #0
	subs r0, #0xa0
	lsls r0, r0, #0x10
	lsrs r1, r0, #0x10
_08001710:
	ldr r0, _08001718 @ =gUnk_03002938
	str r1, [r0]
	pop {r0}
	bx r0
	.align 2, 0
_08001718: .4byte gUnk_03002938

	thumb_func_start sub_0800171C
sub_0800171C: @ 0x0800171C
	push {r4, lr}
	lsls r0, r0, #0x10
	lsrs r1, r0, #0x10
	cmp r1, #0
	beq _08001744
	ldr r4, _0800174C @ =0x04000006
_08001728:
	ldrh r0, [r4]
	adds r2, r0, #0
	ldrh r0, [r4]
...
_08001744:
	...
	bx r0
	.align 2, 0
_0800174C: .4byte 0x04000006

	thumb_func_start sub_08001750
sub_08001750: @ 0x08001750
	push {lr}
	ldr r1, _08001770 @ =gUnk_03007E00
	ldr r3, _08001774 @ =gUnk_03007A00
	ldr r2, _08001778 @ =0x55555555
_08001758:
	str r2, [r1]
	subs r0, r1, #4
	str r2, [r0]
	...
	bx r0
	.align 2, 0
_08001770: .4byte gUnk_03007E00
_08001774: .4byte gUnk_03007A00
_08001778: .4byte 0x55555555

	thumb_func_start sub_0800177C
sub_0800177C: @ 0x0800177C
	push {r4, lr}
	movs r2, #0
	ldr r1, _0800178C @ =gUnk_03007E00
	movs r4, #0xc0
	lsls r4, r4, #0x12
	ldr r3, _08001790 @ =0x55555555
	b _08001796
	.align 2, 0
_0800178C: .4byte gUnk_03007E00
_08001790: .4byte 0x55555555
_08001794:
	subs r1, #4
_08001796:
	cmp r1, r4
...
_080017A4:
	...
	bls _08001794
_080017A8:
	ldr r0, _080017B4 @ =0x03008000
	subs r0, r0, r1
	pop {r4}
	pop {r1}
	bx r1
	.align 2, 0
_080017B4: .4byte 0x03008000

	thumb_func_start sub_080017B8
sub_080017B8: @ 0x080017B8
	ldr r0, [r0]
	lsrs r0, r0, #8
	bx lr
	.align 2, 0

	thumb_func_start sub_080017C0
sub_080017C0: @ 0x080017C0
	movs r0, #0
	bx lr
...
sub_080017D8: @ 0x080017D8
	...
	movs r0, #9
	bl sub_08012F60
	ldr r1, _08001800 @ =gUnk_03003364
	ldr r1, [r1]
	adds r4, r0, r1
	ldr r0, _08001804 @ =0x000343FD
	muls r0, r4, r0
	ldr r1, _08001808 @ =0x00269EC3
	adds r0, r0, r1
	lsrs r4, r0, #0x10
	movs r0, #9
	adds r1, r4, #0
	...
	bx r1
	.align 2, 0
_08001800: .4byte gUnk_03003364
_08001804: .4byte 0x000343FD
_08001808: .4byte 0x00269EC3

	thumb_func_start sub_0800180C
sub_0800180C: @ 0x0800180C
	push {r4, r5, lr}
	adds r4, r0, #0
	lsls r4, r4, #0x10
	lsrs r4, r4, #0x10
	movs r0, #9
	bl sub_08012F60
	ldr r1, _08001844 @ =gUnk_03003364
	ldr r1, [r1]
	adds r5, r0, r1
	ldr r0, _08001848 @ =0x000343FD
	muls r0, r5, r0
	ldr r1, _0800184C @ =0x00269EC3
	adds r0, r0, r1
	lsrs r5, r0, #0x10
	movs r0, #9
	adds r1, r5, #0
	...
	bx r1
	.align 2, 0
_08001844: .4byte gUnk_03003364
_08001848: .4byte 0x000343FD
_0800184C: .4byte 0x00269EC3
...
sub_08001850: @ 0x08001850
	...
	movs r0, #9
	bl sub_08012F60
	ldr r1, _08001888 @ =gUnk_03003364
	ldr r1, [r1]
	adds r5, r0, r1
	ldr r0, _0800188C @ =0x000343FD
	muls r0, r5, r0
	ldr r1, _08001890 @ =0x00269EC3
	adds r0, r0, r1
	lsrs r5, r0, #0x10
	movs r0, #9
	adds r1, r5, #0
	...
	bx r1
	.align 2, 0
_08001888: .4byte gUnk_03003364
_0800188C: .4byte 0x000343FD
_08001890: .4byte 0x00269EC3
...
sub_08001894: @ 0x08001894
	...
	movs r0, #9
	bl sub_08012F60
	ldr r1, _080018CC @ =gUnk_03003364
	ldr r1, [r1]
	adds r6, r0, r1
	ldr r0, _080018D0 @ =0x000343FD
	muls r0, r6, r0
	ldr r1, _080018D4 @ =0x00269EC3
	adds r0, r0, r1
	lsrs r6, r0, #0x10
	movs r0, #9
	adds r1, r6, #0
	...
	bx r1
	.align 2, 0
_080018CC: .4byte gUnk_03003364
_080018D0: .4byte 0x000343FD
_080018D4: .4byte 0x00269EC3
...
sub_080018D8: @ 0x080018D8
	...
	adds r5, r0, #0
	adds r4, r1, #0
	ldr r2, _08001910 @ =0x0000FFFF
	movs r3, #0
	cmp r3, r4
	bhs _08001906
	ldr r6, _08001914 @ =gUnk_08B6D04C
_080018E8:
	adds r0, r5, r3
	ldrb r1, [r0]
	adds r0, r2, #0
...
_08001906:
	...
	bx r1
	.align 2, 0
_08001910: .4byte 0x0000FFFF
_08001914: .4byte gUnk_08B6D04C

	thumb_func_start sub_08001918
sub_08001918: @ 0x08001918
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
sub_08001A18: @ 0x08001A18
	...
	thumb_func_start sub_08001A1C
sub_08001A1C: @ 0x08001A1C
	push {r4, lr}
	bl sub_08001120
	bl sub_080044B0
	bl sub_0800F034
...
_08001A82:
	...
	bl sub_08093418
_08001AA0:
	ldr r1, _08001AE4 @ =gUnk_02006000
	movs r0, #0
	bl sub_08012D14
	movs r0, #4
	bl sub_08012F60
	...
	bx r0
	.align 2, 0
_08001AE4: .4byte gUnk_02006000
_08001AE8: .4byte 0x55555555

	thumb_func_start sub_08001AEC
sub_08001AEC: @ 0x08001AEC
	ldr r1, _08001AF8 @ =gUnk_03002960
	lsls r0, r0, #0x10
	asrs r0, r0, #0x10
	str r0, [r1]
	bx lr
	.align 2, 0
_08001AF8: .4byte gUnk_03002960

	thumb_func_start sub_08001AFC
sub_08001AFC: @ 0x08001AFC
	ldr r0, _08001B04 @ =gUnk_03002968
	ldr r0, [r0]
	bx lr
	.align 2, 0
_08001B04: .4byte gUnk_03002968

	thumb_func_start sub_08001B08
sub_08001B08: @ 0x08001B08
	ldr r1, _08001B10 @ =gUnk_03002968
	movs r0, #1
	str r0, [r1]
	bx lr
	.align 2, 0
_08001B10: .4byte gUnk_03002968

	thumb_func_start sub_08001B14
sub_08001B14: @ 0x08001B14
	ldr r1, _08001B1C @ =gUnk_03002964
	str r0, [r1]
	bx lr
	.align 2, 0
_08001B1C: .4byte gUnk_03002964

	thumb_func_start sub_08001B20
sub_08001B20: @ 0x08001B20
	push {lr}
	sub sp, #8
	ldr r1, _08001B9C @ =0x04000204
	ldr r2, _08001BA0 @ =0x00004014
	adds r0, r2, #0
	strh r0, [r1]
	ldr r2, _08001BA4 @ =0x55555555
	str r2, [sp]
	ldr r0, _08001BA8 @ =0x040000D4
	mov r1, sp
	str r1, [r0]
	movs r1, #0x80
	lsls r1, r1, #0x12
	str r1, [r0, #4]
	ldr r1, _08001BAC @ =0x85010000
	str r1, [r0, #8]
	ldr r1, [r0, #8]
	str r2, [sp]
	mov r2, sp
	...
	bx r0
	.align 2, 0
_08001B9C: .4byte 0x04000204
_08001BA0: .4byte 0x00004014
_08001BA4: .4byte 0x55555555
_08001BA8: .4byte 0x040000D4
_08001BAC: .4byte 0x85010000
_08001BB0: .4byte 0x85001EC0
_08001BB4: .4byte 0x85006000
_08001BB8: .4byte 0x85000100
_08001BBC: .4byte 0x81000200
...
sub_08001BC0: @ 0x08001BC0
	...
	bl sub_080092CC
	bl sub_08006AC4
	ldr r0, _08001BF8 @ =gUnk_03002948
	ldr r1, _08001BFC @ =0x04000006
	ldrh r1, [r1]
	strh r1, [r0]
	bl sub_0800EF48
	bl sub_080092EC
	...
	bx r0
	.align 2, 0
_08001BF8: .4byte gUnk_03002948
_08001BFC: .4byte 0x04000006

	thumb_func_start sub_08001C00
sub_08001C00: @ 0x08001C00
	push {lr}
	bl sub_080132CC
	bl sub_08013A78
	bl sub_08019A94
	...
	thumb_func_start sub_08001C30
sub_08001C30: @ 0x08001C30
	push {r4, lr}
	ldr r1, _08001C60 @ =gUnk_03002960
	ldr r0, [r1]
	cmp r0, #0
	beq _08001C5A
	adds r4, r1, #0
...
_08001C5A:
	...
	bx r0
	.align 2, 0
_08001C60: .4byte gUnk_03002960

	thumb_func_start sub_08001C64
sub_08001C64: @ 0x08001C64
	push {lr}
	ldr r0, _08001C88 @ =gUnk_03002964
	ldr r0, [r0]
	cmp r0, #1
	bne _08001C84
	ldr r0, _08001C8C @ =gUnk_0300594C
	ldrh r1, [r0]
	movs r0, #0xf
	ands r0, r1
	cmp r0, #0xf
	bne _08001C84
	bl sub_080934A8
	ldr r1, _08001C90 @ =gUnk_03002960
	movs r0, #0
	str r0, [r1]
_08001C84:
	pop {r0}
	bx r0
	.align 2, 0
_08001C88: .4byte gUnk_03002964
_08001C8C: .4byte gUnk_0300594C
_08001C90: .4byte gUnk_03002960

	thumb_func_start sub_08001C94
sub_08001C94: @ 0x08001C94
	bx lr
	.align 2, 0
