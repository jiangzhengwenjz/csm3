...
u32 sub_08012B60(void)
{
    u16 r3 = *gUnk_03006574->unk4++;
    gUnk_03006574->unkC[(u32)gUnk_03006574->unk8] = gUnk_03006574->unk4;
    gUnk_03006574->unk8++;
    gUnk_03006574->unk4 = gUnk_03006578->unk28 + ((r3 >> 1 << 1) + 0x10);
