...
struct SaveBlock1
{
    ...
    /*0x42C*/ u8 unk42C[0x1E]; // content: from 00 to 1d, the same as their indices. no idea why they need this.
    /*0x44A*/ u8 itemQuantityList[0xC8]; // TODO: Find out what's the real data structure. The current array is just for matching. 
